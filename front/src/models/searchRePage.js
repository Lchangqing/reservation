    ...
    effects: {
      ...
      *getLayout(action,{call,put}){
        try {
          ...
          layout.stables = layout.stables.split(',').map(i=>parseInt(i));
          layout.mtables = layout.mtables.split(',').map(i=>parseInt(i));
          layout.ltables = layout.ltables.split(',').map(i=>parseInt(i));
          layout.smoking = layout.smoking.split(',').map(i=>parseInt(i));
          layout.no_smoking = layout.no_smoking.split(',').map(i=>parseInt(i));
          layout.window = layout.window.split(',').map(i=>parseInt(i));
